...
instance Print Exp where
  prt i e = case e of
    ...
    EIfElse exp1 exp2 exp3 exp4 -> prPrec i 2 (concatD [doc (showString "if"), prt 3 exp1, doc (showString "="), prt 3 exp2, doc (showString "then"), prt 3 exp3, doc (showString "else"), prt 3 exp4])
