...
/* package LambdaNat-0.1.0.0 */
#ifndef VERSION_LambdaNat
#define VERSION_LambdaNat "0.1.0.0"
#endif /* VERSION_LambdaNat */
#ifndef MIN_VERSION_LambdaNat
#define MIN_VERSION_LambdaNat(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_LambdaNat */
...
/* package traverse-with-class-1.0.0.0 */
#ifndef VERSION_traverse_with_class
#define VERSION_traverse_with_class "1.0.0.0"
...
#define CURRENT_PACKAGE_KEY "LambdaNat-0.1.0.0-EvitBjaHhSP7BnBJ5PUt9C"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "LambdaNat-0.1.0.0-EvitBjaHhSP7BnBJ5PUt9C"
